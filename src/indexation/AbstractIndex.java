...
public abstract class AbstractIndex implements Serializable {
	 ...
	 * fichier inverse.
	 * 
	 * @param tokenListType Type de liste à utiliser pour stocker les tokens lors de
	 *                      l'indexation.
	 * @param lexiconType   Type de structure de données utilisée pour stocker le
	 *                      lexique.
	 * @return Index représentant le corpus.
	 * 
	 * @throws UnsupportedEncodingException Problème de décodage lors de la lecture
	 *                                      d'un document.
	 * @throws FileNotFoundException        Problème de lecture de fichier
	 */
	public static AbstractIndex indexCorpus(TokenListType tokenListType, LexiconType lexiconType)
	...
	/**
	 * Permet de controler le type de liste utilisé pour stocker les tokens lors de
	 * l'indexation.
	 */
	 ...
	 * stockées.
	 * 
	 * @param indexEntry L'entrée à ajouter à l'index.
	 * @param rank       Le numéro de l'entrée dans le lexique. Cette information
	 *                   n'est utile que dans le cas où le lexique est un tableau.
	 */
	 ...
	 * 
	 * @throws IOException            Problème lors de la lecture de l'index.
	 * @throws ClassNotFoundException Problème lors de la lecture de l'index.
	 */
	...
	/**
	 * Enregistrement de cet index dans le fichier configuré. On utilise simplement
	 * le mécanisme de sérialisation de Java.
	 * 
	 * @throws IOException Problème lors de l'écriture de l'index.
	 */
	public void write() throws IOException { // TODO méthode à compléter (TP2-ex10)
	}
