...
public class Builder {
	 ...
	 * 
	 * @param tokens      Liste normalisée de tokens à traiter.
	...
	/**
	 * Supprime de la liste les occurrences multiples de tokens, à condition qu'ils
	 * appartiennent au même document. Bien sûr, on garde quand même une occurrence.
	 * 
	 * @param tokens La liste normalisée et triée de tokens à traiter.
	 ...
	 * qu'elles appartiennent au même document. Bien sûr, on garde quand même une
	 * occurrence. <br/>
	 * Par rapport à {@link #filterTokens(List)}, cette méthode calcule en plus les
	 * fréquences des tokens dans chaque document où ils apparaissent.
	 * 
	 * @param tokens      La liste normalisée et triée de tokens à traiter.
	 * @param frequencies La liste des fréquences associées à ces tokens.
	 * @return Nombre de termes distincts dans la liste.
	 */
	 ...
	 * 
	 * @param tokens Liste normalisée, triée et filtrée de tokens.
	 * @param index  L'index obtenu, sous forme de fichier inverse.
	 ...
	 * La différence avec {@link #buildPostings(List, AbstractIndex)} est que cette
	 * méthode prend une liste supplémentaires contenant les fréquences des termes.
	 * 
	 * @param tokens      Liste normalisée, triée et filtrée de tokens.
	 * @param frequencies La liste des fréquences associées à ces tokens.
	 * @param index       L'index obtenu, sous forme de fichier inverse.
