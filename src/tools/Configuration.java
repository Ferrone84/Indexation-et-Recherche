...
public class Configuration {
	...
	/**
	 * Permet à l'utilisateur de spécifier le nom du corpus à traiter par
	 * l'index.
	 * 
	 * @param corpusName
	 *            Noms du corpus : {@code wp}, {@code wp_test} ou
	 *            {@code springer}.
	 */
	 ...
	 * 
	 * @return Noms du corpus : {@code wp}, {@code wp_test} ou {@code springer}.
	 */
	...
	/**
	 * Permet d'indiquer si les mots-vides doivent être filtrés ({@code true})
	 * ou pas ({@code false}).
	 * 
	...
	/**
	 * Indique si les mots-vides doivent être filtrés ({@code true}) ou pas (
	 * {@code false}).
	 * 
	 * @return Filtrer les mots-vides ({@code true}) ou pas ({@code false}).
	 */
	...
	/**
	 * Permet d'indiquer si les tokens doivent être racinisés ({@code true}) ou
	 * pas ({@code false}).
	 * 
	...
	/**
	 * Indique si les tokens doivent être racinisés ({@code true}) ou pas (
	 * {@code false}).
	 * 
	 * @return Raciniser les tokens ({@code true}) ou pas ({@code false}).
	 */
	...
	/**
	 * Permet d'indiquer si les scores doivent être calculés ({@code true}) ou
	 * pas ({@code false}).
	 * 
	...
	/**
	 * Indique si les scores doivent être calculés ({@code true}) ou pas (
	 * {@code false}).
	 * 
	 * @return Calculer les scores ({@code true}) ou pas ({@code false}).
	 */
